      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 lg:py-8">
              ...
              <ul className="text-gray-300 font-medium">
                <li className="mb-4">
                  <NavLink
                    to="/"
                    className={({ isActive }) =>
                      `text-gray-300 hover:text-orange-300 ${isActive ? "text-orange-300" : ""}`
                    }
                  >
                    Home
                  </NavLink>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-300 sm:text-center">
            © 2025
            <a href="https://github.com/aayush192" className="hover:text-orange-300">
              Treasure Hunter
            </a>
            . All Rights Reserved.
          </span>
